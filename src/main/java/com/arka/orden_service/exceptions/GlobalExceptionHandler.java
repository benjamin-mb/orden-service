...
public class GlobalExceptionHandler {
    ...
    public ErrorResponseDto handleNotFound(RuntimeException ex, WebRequest request) {
    ...
    public ErrorResponseDto handleOrdenInvalidState(OrdenInvalidStateException ex, WebRequest request) {
        return new ErrorResponseDto(
                LocalDateTime.now(),
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponseDto handleIllegalArgument(IllegalArgumentException ex, WebRequest request) {
        return new ErrorResponseDto(
                LocalDateTime.now(),
                HttpStatus.BAD_REQUEST.value(),
                "Bad Request",
